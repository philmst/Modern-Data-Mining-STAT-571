...
rename(diff_2010to2014_print, "Payroll increase from 2010 to 2014 (%)" = diff_payroll_log.2010to2014)

```

```{r print top 5 payroll increase, echo=FALSE}
knitr::kable(diff_2010to2014_print)
```
...
rename(win_4yrchange, "Percentage gains in wins (2014 vs 2010, in %)" = win_pct_4yrchange)
```

```{r print top 5 win_pct increase using knitr, echo=FALSE}
knitr::kable(win_4yrchange)
```
